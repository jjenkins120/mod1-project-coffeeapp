...
puts "
                ...
                `-//:-.``                                     `..://:.     
              :so-`                                                `./s/`  
 ```````````.sd:           `.-://+ossyyyyyhhhyysssooo+/:-..`          .yh- 
shhhhhhhhhhhhmd`      .:+shhddmmmmmmmmmmmmmmmmddhysoo+ooosssyo/-`      smh 
hmmmmhhhhhhhdmmh:`  :ydmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmddhyo/:-+ydh+`  -ommd 
+mmmh```````-mmmmho/mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmdy/`hmmo+ydmmms 
`hmmm.       dmh/shdmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmymmmmhy+smm/ 
 .dmmy`      +mm. `.:+syhddmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmddhhso/-.  hmd` 
  .ymms.     `dmo       `..-:/+oosyyyhhhhhhhhhhhhyyysso+/:--.`       /mmo  
   `+hmh/`    :mm-                    ``````````                    .dmd`  
     `/ydh+.   omh.                                                `ymd:   
        -/syo/..smy`                                              `smm/    
            .---.+dh.                                            `smd/     
